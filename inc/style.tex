...
\newcommand{\outlinename}{Inhalt dieses Vortrags}
...
% load logo collection inspired by the package
% dtklogos from "Die TeXnische Komödie"
% dtklogos overwrites \tikz which has very bad consequences
\input{logos}
...
\mtcsettitle{minitoc}{\outlinename}
...
\ihead{\shorttitlestring\ \textcolor{maincolor}{\bfseries |}
  \leftmark\ \textcolor{maincolor}{\bfseries |}
...
\renewenvironment{Beispiele}[1][]{%
  \Block{Beispiele\ifthenelse{\equal{#1}{}}{}{ (#1)}}
}{%
  \endBlock
}
