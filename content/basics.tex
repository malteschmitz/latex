...
\begin{Frame}[fragile,t]{Befehle}
  ...
  \begin{itemize}
    ...
    \item<2> Optionale Paramter stehen in eckigen Klammern.
  \end{itemize}
  ...
  \begin{onlyenv}<2>
    \xxx
    \begin{Beispiel}[Befehl mit optionalen Parametern]
      \begin{lstlisting}[gobble=8,style=block]
...
\begin{Frame}[fragile]{Umgebungen}
  \begin{itemize}
    \item Eine Umgebung beginnt mit \lstinline-\begin-
    \item und endet mit \lstinline-\end-.
    \item Parameter ist jeweils der Name der Umgebung.
  \end{itemize}
