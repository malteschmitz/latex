...
\plain{\includegraphics{demo/beamer-struktur.pdf}}
...
\plain{\includegraphics[page=2]{demo/beamer-struktur.pdf}}
...
\plain{\includegraphics[page=3]{demo/beamer-struktur.pdf}}
...
\plain{\includegraphics{demo/beamer-listing.pdf}}
...
\plain{\includegraphics[page=23]{demo/beamer-Boadilla.pdf}}
\plain{\includegraphics[page=23]{demo/beamer-Madrid.pdf}}
\plain{\includegraphics[page=23]{demo/beamer-Rochester.pdf}}
\plain{\includegraphics[page=23]{demo/beamer-Montpellier.pdf}}
\plain{\includegraphics[page=23]{demo/beamer-Goettingen.pdf}}
\plain{\includegraphics[page=23]{demo/beamer-Frankfurt.pdf}}
\plain{\includegraphics[page=23]{demo/beamer-Luebeck.pdf}}
...
\begin{Frame}[fragile]{Ein- und Ausblenden}
  ...
  \end{lstlisting}
  In diesem \uncover<3->{Satz} werden \only<4->{Worte }eingeblendet.
\end{Frame}
...
\begin{Frame}[fragile]{Einbinden des Inhalts}
  \begin{center}
    \begin{tikzpicture}[
      ...
      \node[texicon] (content tex) {\shortstack{\icon{TEX}\\\texttt{content.tex}}};

      \uncover<2->{
        \node[texicon, below left=of content tex] (beamer tex)
          {\shortstack{\icon{TEX}\\\texttt{beamer.tex}}};
        \node[texicon, below right=of content tex] (article tex)
          {\shortstack{\icon{TEX}\\\texttt{article.tex}}};
      }
      ...
      \uncover<3->{
        ...
        \node[pdficon, below=of make beamer] (beamer pdf)
          {\shortstack{\icon{PDF}\\\texttt{beamer.pdf}}};
        \node[pdficon, below=of make article] (article pdf)
          {\shortstack{\icon{PDF}\\\texttt{article.pdf}}};
      }
