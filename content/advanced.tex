...
\begin{Frame}[fragile]{TODO}
  \begin{verbatim}
    ...
    Randnotizen
      \marginpar{wichtiger Hinweis}
      \marginpar[linke Seite]{rechte Seite}
        je nach dem, ob die aktuelle Seite eine linke oder eine rechte Seite ist

      Randnotizen werden \alert{nicht} auf mehrere Seite verteilt
  \end{verbatim}
\end{Frame}
...
\begin{Frame}{Satzspiegelberechnung}{einseitiger Druck}
  \[ \frac{\op{Satzspiegelhöhe}}{\op{Satzspiegelbreite}} =
      \frac{\op{Seitenhöhe}}{\op{Seitenbreite}} \]

  \[ \frac{\op{oberer\ Rand}}{\op{unterer\ Rand}} = \frac12 \]

  \[ \op{linker\ Rand} = \op{rechter\ Rand} \]
\end{Frame}
...
\begin{Frame}[fragile]{Seitenstil konfigurieren}{Zuordnung der Befehle zur Konfiguration der Seitenstile}
  \begin{center}
    \begin{tikzpicture}[
      ...
      \node at (-3,3)
        {\shortstack{\strut linke Seite,\\ \strut gerade Seitenzahl,\\ \strut even page}};
      \node at (3,3)
        {\shortstack{\strut linke Seite,\\ \strut ungerade Seitenzahl,\\ \strut odd page}};
...
\begin{Frame}[fragile,allowframebreaks]{TODO}
  \begin{verbatim}
