...
\begin{Frame}
  \begin{center}
    \alt<presentation>{
      ...
      \fbox{\includegraphics[width=.5\textwidth]{demo/thesis-titlepage.pdf}}
    }
  \end{center}
\end{Frame}
...
\begin{Frame}[fragile]{Quelltext der Titelseite}
  \begin{lstlisting}[gobble=4,frame=bottomline]
...
\begin{Frame}[fragile]{Gestaltung der Abschnitte}
  ...
  \alt<presentation>{%
    \setlength{\descriptionwidth}{6.2cm}
  }{%
    \setlength{\descriptionwidth}{7.2cm}
  }
