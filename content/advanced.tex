...
\begin{Frame}[fragile]{Quelltext der Titelseite}{Umgebung und Logo}
  \begin{lstlisting}[gobble=4]
    \begin{titlepage}
      \thispagestyle{empty}

      \vspace{1cm}
      \includegraphics[height=22mm]%
        {beispiel-logo.pdf}
...
\begin{Frame}[fragile]{Quelltext der Titelseite}{Titel}
  \begin{lstlisting}[gobble=4]
    \vspace{2.5cm}
    \LARGE
  ...
  \begin{center}
    ...
    \only<6->{%
      \begin{tikzpicture}
        ...
        \uncover<7->{%
          \node[maincolor,label=\texttt{\ \ config}, above left=of main] (config) {\icon[2]{TEX}};
          \path[very thick]
        ...
        \uncover<8->{%
          \node[maincolor,label=\texttt{\ \ chap1}, above right=of main] (chap1) {\icon[3]{TEX}};
          \path[very thick]
        ...
        \uncover<9->{%
          \node[maincolor,label=\texttt{\ \ chap2}, below right=of main] (chap2) {\icon[5]{TEX}};
          \path[very thick]
        ...
        \uncover<10->{%
          \node[maincolor,label=\texttt{\ \ chap3}, below left=of main] (chap3) {\icon[4]{TEX}};
          \path[very thick]
