...
\begin{Frame}[fragile]{Manueller Satzspiegel}
  ...
  \begin{Block}{In der Präambel für eigeneren Satzspiegel}
    \begin{lstlisting}[gobble=6,style=block]
      \usepackage{geometry}
      \geometry{a5paper,%
        top=2cm,bottom=4cm,left=2cm,right=4cm}
      % oder auch
      \geometry{papersize={20cm,30cm},%
        top=2cm,bottom=4cm,inner=2cm,outer=4cm}
    \end{lstlisting}
  \end{Block}
\end{Frame}
...
\begin{Frame}[fragile]{Seitenstil konfigurieren}{Zuordnung der Befehle zur Konfiguration der Seitenstile}
  \begin{center}
    \begin{tikzpicture}[
      ...
      \node at (3,3)
        {\shortstack{\strut rechte Seite,\\ \strut ungerade Seitenzahl,\\ \strut odd page}};
